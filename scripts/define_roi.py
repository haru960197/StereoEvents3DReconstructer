...
def parse_args() -> argparse.Namespace:
	...
	parser.add_argument("--output", default="roi_mask.png", help="Output binary mask image path")
	parser.add_argument("--meta", default="roi_mask_meta.json", help="Output metadata JSON path")
